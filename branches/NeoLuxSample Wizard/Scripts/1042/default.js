...
function AddFilters(proj) {
    try {
        // 프로젝트에 폴더를 추가합니다.
        var group;
        group = proj.Object.AddFilter('Source file');
        group.Filter = 'cpp;c;cc;cxx;def;odl;idl;hpj;bat;asm;asmx';

        group = proj.Object.AddFilter('Header file');
        group.Filter = 'h;hpp;hxx;hm;inl;inc;xsd';

        group = proj.Object.AddFilter('Resource file');
        group.Filter = 'rc;ico;cur;bmp;dlg;rc2;rct;bin;rgs;gif;jpg;jpeg;jpe;resx;tiff;tif;png;wav;mp3;wma;wmv;avi;ase;3ds';

        group = proj.Object.AddFilter('Document file');
        group.Filter = 'doc;txt;hwp;ppt;pptx;rtf';
    }
    catch (e) {
        throw e;
    }
...
function AddConfig(proj, strProjectName) {
    try {
        ...
        config.IntermediateDirectory = '../output/$(ProjectName)';
        config.OutputDirectory = '../output/$(ProjectName)';
        ...
        // TODO: 링커 설정을 추가합니다.
        LinkTool.AdditionalLibraryDirectories   = "../lib";
        LinkTool.AdditionalDependencies         = "NeoLux.lib"
        ...
        config.IntermediateDirectory = '../Release/$(ProjectName)';
        config.OutputDirectory = '../Release/$(ProjectName)';
        ...
        CLTool.WarningLevel             = warningLevel_3;
        CLTool.Optimization             = optimizeDisabled;
        CLTool.PreprocessorDefinitions  = 'WIN32;_WINDOWS';
        CLTool.MinimalRebuild           = true;
        CLTool.BasicRuntimeChecks       = runtimeBasicCheckAll;
...
// SIG // MDgwODAxMDQ1MTM3WjAjBgkqhkiG9w0BCQQxFgQUFqso
// SIG // 4CAh27Kw8u7dxFFeGEydqYcwDQYJKoZIhvcNAQEFBQAE
// SIG // ggEAUdtK2hZ8wZ+ilwXaJN5QP6Al+PH6suV07OuXJ0XN
// SIG // a4PYUJBb+VTAZ9Hn0b4ae5enmuVZ0kMj4z/wLH0Nded/
// SIG // UXpZ8Rg3QacAKcgytPrZm2lUfkup0yHuVNurqnGJbbHM
// SIG // xCRxgt+b09yTrJMSX1/cpDEhXePQUtWSO/exEgWFnAGz
// SIG // u4XtXQPqfXzhQA9uukzOg3bgGiwQyGb36NzY/ssydOL/
// SIG // GTExBM1T6PSTnYvw+IWCFWZFYscK+kEztcJiYVEcvWAC
// SIG // WDRYwwDc/qutn/r/DKmOodGVQp2tWLcBiUNnXEklif3W
// SIG // V7ljUWhANmaQyivFufq0WyxJsEL+DvSaz6kC1A==

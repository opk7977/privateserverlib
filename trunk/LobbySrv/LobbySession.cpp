...
#ifdef _DEBUG
	m_logger->PutLog( SLogger::LOG_LEVEL_DBGINFO, _T("LobbySession::RecvChat()\n")
												_T("[%s] %s\n\n")
												, m_myCharInfo->GetID()
												, chatText );
...
// 
// #ifdef _DEBUG
// 	m_logger->PutLog( SLogger::LOG_LEVEL_DBGINFO, _T("LobbySession::SendRoomCharOut()\n")
// 												_T("[All In Lobby] 전송되었습니다.\n\n") );
// 
// #endif
